...
public class TargetLocator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //problem lies here only
        enemyMovers = GameObject.FindGameObjectsWithTag("enemy");
        Debug.Log("the count of enemymovers "+enemyMovers.Length);
    ...
    {
        foreach(GameObject enemymover in enemyMovers)
        {
         
            if (enemymover.gameObject.activeInHierarchy)
            {
                Debug.Log(enemymover.transform.name);
